      ...
      <main className="flex-1 p-4 sm:p-6 overflow-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-10 bg-gradient-to-r from-[#EA3C1F] to-[#F26742] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all"
            ...
            >
              {projects.map((project) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h4 className="text-lg font-semibold text-gray-800 truncate">{project.title}</h4>
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className={`w-full bg-gradient-to-r from-[#EA3C1F] to-[#F26742] text-white py-2 px-4 rounded-lg font-medium hover:shadow-md transition-all ${
